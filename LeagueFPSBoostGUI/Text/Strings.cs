...
namespace LeagueFPSBoost.Text
{
    public static class Strings
    {
        ...
        public const string Updater_Download_URL_SETUP = @"https://github.com/DjordjeMandic/LeagueFPSBoost/raw/master/AutoUpdater/Installer/LeagueFPSBoostSetup.exe";
        public const string Updater_Download_URL = Updater_Download_URL_SETUP;
